    ...
    <div class="flex flex-wrap -mx-3">
        ...
        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
            <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent flex justify-between items-center">
                ...
                <a class="inline-block px-6 py-3 font-bold text-center text-white uppercase align-middle transition-all bg-transparent rounded-lg cursor-pointer leading-pro text-xs ease-soft-in shadow-soft-md bg-150 bg-gradient-to-tl from-green-600 to-lime-400 hover:shadow-soft-xs active:opacity-85 hover:scale-102 tracking-tight-soft bg-x-25"
                href="{{ route('restaurants.index') }}"> <i class="fa fa-check"></i> Active Accounts </a>
            </div>
            ...
            <div class="p-0 overflow-x-auto">
                ...
                <thead class="align-bottom">
                    <tr>
                    <th class="px-6 py-3 font-bold text-left uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">Restaurant</th>
                    <th class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">Tables</th>
                        ...
                        <tr>
                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                ...
                                <div class="flex flex-col justify-center">
                                    <h6 class="mb-0 leading-normal text-sm">{{ $restaurant->name }}</h6>
                                    <p class="mb-0 leading-tight text-xs text-slate-400">{{ $restaurant->email }}</p>
                                </div>
                                </div>
                            </td>
                            ...
                            <td class="p-2 leading-normal text-center align-middle bg-transparent border-b text-xs whitespace-nowrap shadow-transparent">
                                <span class="bg-gradient-to-tl text-xs rounded-2 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none px-4 py-2">
                                    @if ($restaurant->business_permit != null )
                                    <a href="{{ asset('/storage/permits/restaurant/' . $restaurant->id .'/'. $restaurant->business_permit) }}" alt="">
                            ...
                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                <div class="align-center flex items-center">
                                    ...
                                    <form method="POST" action="{{ route('restaurants.archives.restore', $restaurant) }}">
                                        @csrf
                                        @method('PATCH')
                                    ...
                                    <form method="POST" action="/admin/restaurants/{{ $restaurant->id }}">
                                        ...
                                        <button class="font-semibold leading-tight text-xs text-red-400 px-1">Permanet Delete</button>
                                    </form>
