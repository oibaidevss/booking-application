                        ...
                        <div
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="flex flex-col">
                                    <h6 class="mb-1 leading-normal text-sm text-slate-700">{{ $restaurant->name }}</h6>
                                    <span class="leading-tight text-xs">{{ $restaurant->location }}</span>
                                </div>

                            </div>
                            <div class="flex flex-col items-left justify-center">
                                <p class="relative z-10 inline-block m-0 font-semibold leading-normal text-transparent bg-gradient-to-tl text-slate-400 text-sm bg-clip-text"> <i class="fa fa-envelope"></i> &nbsp {{ $restaurant->email }}</p>

                                <p class="relative z-10 inline-block m-0 font-semibold leading-normal text-transparent bg-gradient-to-tl text-slate-400 text-sm bg-clip-text"> <i class="fa fa-phone"></i> &nbsp  {{ $restaurant->number }}</p>
                            </div>
                        </div>
                        ...
                        <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                            ...
                            <li class="">
                                <div class=" p-6 mb-2 border-0 rounded-t-inherit rounded-xl bg-gray-50">
                                    ...
                                    <div class="flex flex-col">
                                        <span class="mb-2 leading-tight text-xs">Table: 
                                    ...
                                    <div class="ml-auto text-right">
                                        ...
                                        <a class="inline-block px-6 py-3 font-bold text-center text-white uppercase align-middle transition-all bg-transparent rounded-lg cursor-pointer leading-pro text-xs ease-soft-in shadow-soft-md bg-150 bg-gradient-to-tl from-gray-900 to-slate-800 hover:shadow-soft-xs active:opacity-85 hover:scale-102 tracking-tight-soft bg-x-25"
                                            href="{{ route('customer.restaurant.booking') }}?restaurant={{ $restaurant->id }}&table={{ $restaurant->id }}">
                                            <i class="mr-2 fas fa-plus text-white-700" aria-hidden="true"></i>Book This
                                            Table</a>
                                    </div>
                                    </div>
                                    <p class="mb-2 leading-tight text-xs">{!! $table->description !!}</p>
                                </div>
