                ...
                <div class="flex flex-wrap -mx-3">
                    ...
                    <div class="w-full max-w-full px-3 mt-6 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                        <div
                            ...
                            <div class="relative">
                                <a class="block shadow-xl rounded-2xl">
                                    <img src="{{ ($spot->picture != '') ? asset("/storage/pictures/spot/$spot->id/" . $spot->picture):asset('/assets/img/home-decor-1.jpg') }}" alt="img-blur-shadow"
                                        class="max-w-full shadow-soft-2xl rounded-2xl">
                                </a>
                            </div>
                            <div class="flex-auto px-1 pt-6">
                                ...
                                <div class="flex justify-between align-center align-middle ">
                                    ...
                                    <p class="text-sm text-lime-500">{{ $spot->price_range }}</p>
