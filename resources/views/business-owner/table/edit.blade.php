                ...
                <div
                    ...
                    <div class="p-4 pb-0 mb-0 bg-white border-b-0 rounded-t-2xl">
                        <div class="flex flex-wrap -mx-3">
                            ...
                            <div class="flex items-center w-full max-w-full px-3 shrink-0 md:w-8/12 md:flex-none">
                                <h6 class="mb-0">Update table Information</h6>
                            </div>
                    ...
                    <div class="flex-auto p-4">
                        <form action="{{ route('table.update', $table) }}" method="POST">
                            ...
                            <x-form.input :value="$table->table_number" name="table_number" label="table Number" required />
                            ...
                            <x-form.field>
                                ...
                                <div class="mb-2">
                                    <textarea
                                        ...
                                        name="description" id="description" class="block mt-1 w-full">{{ $table->description }}</textarea>
                                </div>
